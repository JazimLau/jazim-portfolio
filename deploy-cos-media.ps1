...
Write-Host '    4) Media domain = COS default (jazimprofile-media-1465643833.cos.ap-guangzhou.myqcloud.com)'
Write-Host '       custom domain media.jazimportfolio.com needs ICP filing (later)'
